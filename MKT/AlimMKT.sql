...
BEGIN
	...
	-- FILM
	FOR cpt IN 1..40 LOOP
		INSERT INTO FILM (IDFILM, MOYCOTES) VALUES (FLOOR(DBMS_RANDOM.VALUE(1, 358376)), ROUND(DBMS_RANDOM.VALUE(0, 10), 1));
	END LOOP;
	...
	FOR cpt IN (SELECT * FROM FILM) LOOP
		INSERT INTO LINK_FILM_PAYS (IDFILM, IDPAYS) VALUES (cpt.IDFILM, FLOOR(DBMS_RANDOM.VALUE(1, 30)));
		INSERT INTO LINK_FILM_ACTEUR (IDFILM, IDACTEUR) VALUES (cpt.IDFILM, FLOOR(DBMS_RANDOM.VALUE(1, 30)));
		INSERT INTO LINK_FILM_GENRE (IDFILM, IDGENRE) VALUES (cpt.IDFILM, FLOOR(DBMS_RANDOM.VALUE(1, 30)));
	END LOOP;
	...
	-- SALLE
	FOR cpt1 IN 1..3 LOOP
		FOR cpt2 IN 1..10 LOOP
			INSERT INTO SALLE (IDSALLE, PLACESTOTALES, IDCOMPLE) VALUES (cpt2, FLOOR(DBMS_RANDOM.VALUE(100, 300)), 'CC'||cpt1);
		END LOOP;
	END LOOP;


	-- PROGRAMMATION
	INSERT INTO PROGRAMMATION (IDFILM, DEBUT, PLACESVENDUES, IDSALLE) VALUES (to_timestamp('23/09/15 17:24:00','DD/MM/RR HH24:MI:SSXFF'), );
