...
(
	PERIODE VARCHAR2 CONSTRAINT PK_DIM_PERIODE PRIMARY KEY
);
...
(
	NATIONALITE		NUMBER CONSTRAINT REF_DIM_PAYS REFERENCES DIM_PAYS(PAYS),
	NBJOURSPROJ 	NUMBER
);
...
(
	GENRE		VARCHAR2 CONSTRAINT REF_DIM_GENRE REFERENCES DIM_GENRE(GENRE),
	SALLE		NUMBER CONSTRAINT REF_DIM_SALLE REFERENCES DIM_SALLE(SALLE),
	PERIODE		VARCHAR2 CONSTRAINT REF_DIM_PERIODE REFERENCES DIM_PERIODE(PERIODE),
	JOUR		NUMBER CONSTRAINT REF_DIM_JOUR REFERENCES DIM_JOUR(JOUR),
	SEMAINE		NUMBER CONSTRAINT REF_DIM_SEMAINE REFERENCES DIM_SEMAINE(SEMAINE),
	MOIS		DATE CONSTRAINT REF_DIM_MOIS REFERENCES DIM_MOIS(MOIS),
	POPULARITE	NUMBER
);
...
(
	FILM			NUMBER CONSTRAINT REF_DIM_FILM REFERENCES DIM_FILM(FILM),
...
(
	SALLE		NUMBER CONSTRAINT REF_DIM_SALLE REFERENCES DIM_SALLE(SALLE),
	COMPLEXE	VARCHAR2 CONSTRAINT REF_DIM_COMPLEXE REFERENCES DIM_COMPLEXE(COMPLEXE),
	MOIS		DATE CONSTRAINT REF_DIM_MOIS REFERENCES DIM_MOIS(MOIS),
	ANNEE		DATE CONSTRAINT REF_DIM_ANNEE REFERENCES DIM_ANNEE(ANNEE),
	PROPORTION	NUMBER
);
...
(
	...
	SEMAINE		NUMBER CONSTRAINT REF_DIM_SEMAINE REFERENCES DIM_SEMAINE(SEMAINE),
	ANNEE		DATE CONSTRAINT REF_DIM_ANNEE REFERENCES DIM_ANNEE(ANNEE),
	PAYS		VARCHAR2 CONSTRAINT REF_DIM_PAYS REFERENCES DIM_PAYS(PAYS),
	TURNOVER	NUMBER
);
