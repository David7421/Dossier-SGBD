...
(
	...
	NBR_COPY		NUMBER CONSTRAINT CK_FILM_NBR_COPY_NULL CHECK(NBR_COPY IS NOT NULL),
	CONSTRAINT CK_NBR_COPY_POSITIF CHECK(NBR_COPY > 0)
);
...
CREATE TABLE PAYS
(
	ID 		NUMBER CONSTRAINT PK_PAYS_ID PRIMARY KEY,
	NOM 	VARCHAR2(31)
);
...
(
	...
	ID_PAYS			NUMBER CONSTRAINT REF_PAYS_ID REFERENCES PAYS(ID),
	CONSTRAINT PK_FILM_PAYS  PRIMARY KEY (ID_FILM, ID_PAYS)
);

CREATE TABLE REALISATEUR
(
	ID 		NUMBER CONSTRAINT PK_REALISATEUR_ID PRIMARY KEY,
	NOM 	VARCHAR2(23) CONSTRAINT CK_NOM_REAL_NOTNULL CHECK(NOM IS NOT NULL),
	PHOTO	VARCHAR2(32)
);
...
(
	...
	ID_REALISATEUR	NUMBER CONSTRAINT REF_REALISATEUR_ID REFERENCES REALISATEUR(ID),
	CONSTRAINT PK_FILM_REALISATEUR  PRIMARY KEY (ID_FILM, ID_REALISATEUR)
);

CREATE TABLE ACTEUR
(
	ID 			NUMBER CONSTRAINT PK_ACTEUR_ID PRIMARY KEY,
	NOM 		VARCHAR2(23) CONSTRAINT CK_NOM_ACTEUR_NOTNULL CHECK(NOM IS NOT NULL),
	PHOTO		VARCHAR2(32)
);

CREATE TABLE FILM_ACTEUR
(
	ID_FILM 		NUMBER CONSTRAINT REF_FILM_ACTEUR_ID REFERENCES FILM (ID),
	ID_ACTEUR	NUMBER CONSTRAINT REF_ACTEUR_ID REFERENCES ACTEUR(ID),
...
(
	ID_ACTEUR		NUMBER CONSTRAINT REF_ACTEUR_ROLE_ID REFERENCES ACTEUR(ID),
	ROLE_FILM		NUMBER,
	ROLE_ID			NUMBER,
	CONSTRAINT PK_ACTEUR_ROLE PRIMARY KEY (ID_ACTEUR, ROLE_FILM, ROLE_ID),
